...
private:
    ...
    static void createVirtPlanes(glm::mat4 view, glm::mat4 projection, glm::vec3 viewPos, glm::vec3 startPos, glm::vec3 endPos);
    static void RenderQuad();
    static GLfloat *createVirtualPlanes(glm::mat4 view, glm::mat4 projection, glm::vec3 viewPos, float* arr, glm::vec3 startPos, glm::vec3 endPos);
};
#endif //SCATTERING_H
